...
func (o *User) GetUserBooks() UserBookSlice {
	if o == nil {
		return nil
	}
...
func (r *userR) GetUserBooks() UserBookSlice {
	if r == nil {
		return nil
	}
...
func (o *User) UserBooks(mods ...qm.QueryMod) userBookQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`user_books`.`user_id`=?", o.ID),
	)
...
func (userL) LoadUserBooks(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`user_books`),
		qm.WhereIn(`user_books.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *User) AddUserBooks(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserBook) error {
	var err error
